...
public:
    ...
    // Direct access methods (without shielding framework)
    void DirectAcquire(cna_node* me) {
        cna_acquire(me);
    }
    
    void DirectRelease(cna_node* me) {
        cna_release(me);
    }
    ...
    void DirectAcquire() {
        ...
        cna_acquire(cna_thread_node);
    }
    
    void DirectRelease() {
        assert(cna_thread_node != nullptr);
        cna_release(cna_thread_node);
    }
};
